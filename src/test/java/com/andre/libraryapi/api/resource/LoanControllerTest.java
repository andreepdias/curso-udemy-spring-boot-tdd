...
import com.andre.libraryapi.service.LoanServiceTest;
...
import static com.andre.libraryapi.api.resource.BookControllerTest.BOOK_API;
...
public class LoanControllerTest {
    ...
    public void createLoanTest() throws Exception{
        ...
        LoanDTO dto = LoanDTO.builder().isbn("123").customer("André").customerEmail("andre@email.com").build();
        ...
        Loan loan = Loan.builder().id(1L).customer("André").book(book).loanDate(LocalDate.now()).build();
    ...
    public void invalidIsbnCreateLoanTest() throws Exception{
        LoanDTO dto = LoanDTO.builder().isbn("123").customer("André").build();
        String json = new ObjectMapper().writeValueAsString(dto);
        ...
        mvc.perform(request)
                ...
                .andExpect(jsonPath("errors[0]").value("Book not founded for passed isbn."));
